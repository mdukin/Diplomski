...
if __name__ == '__main__':
    ...
    ds_train_bez0 = MNISTMetricDataset(mnist_download_root, split='train',remove_class=0)
    ...
    for epoch in range(epochs):
        print(f"Epoch: {epoch}")
        t0 = time.time_ns()
        train_loss = train(model, optimizer, train_loader_bez0, device)
